 ...
 * The module is identified by its fully-qualified namespace (e.g., 'Maginium_ProductApi')
 * and the path where the module's files are located (in this case, the current directory).
 *
 * Example usage:
 *   Module::register('Maginium_ProductApi', __DIR__);
 *
 * @param string $namespace The fully-qualified namespace of the module (e.g., 'Maginium_ProductApi').
 * @param string $path The absolute file system path to the module's directory.
 */
Module::register(
    'Maginium_ProductApi', // The fully-qualified namespace of the module
