...
namespace Maginium\ProductElasticIndexer\Models\Indexer\Fulltext\Action;

use Magento\Framework\App\AreaList;
use Maginium\ElasticIndexer\Models\Indexer\Fulltext\Action\AbstractAction;
use Maginium\ProductElasticIndexer\Models\ResourceModel\Indexer\Fulltext\Action\FulltextIndexer as ResourceModel;

/**
 * Class Full.
 *
 * Handles the full reindexing action for the product elastic indexer.
